...
# 49 "MCAL_layer/TIMER3/../mcal_std_types.h"
...
# 15 "MCAL_layer/TIMER3/../GPIO/hal_GPIO.h"
# 1 "MCAL_layer/TIMER3/../GPIO/hal_gpoi_config.h" 1
...
# 1 "MCAL_layer/TIMER3/../INTERRUPT/mcal_interrupt_cnfg.h" 1
# 15 "MCAL_layer/TIMER3/../INTERRUPT/mcal_interrupt_config.h" 2
# 56 "MCAL_layer/TIMER3/../INTERRUPT/mcal_interrupt_config.h"
typedef enum {
...
# 170 "MCAL_layer/TIMER3/../INTERRUPT/mcal_internal_interrupt.h"
...
# 7 "MCAL_layer/TIMER3/hal_timer3.c" 2


 void(*TIMER3_interrupt_handler) (void) = ((void*)0);
...
Std_ReturnType TIMER3_initialization (const TIMER3_config_t *TIMER3_obj){
    ...
    else
    {
        ...
        (T3CONbits.T3CKPS = TIMER3_obj->TIMER3_prescale_vlaue);
...
Std_ReturnType TIMER3_read_counter_reg_vlaue (const TIMER3_config_t *TIMER3_obj , uint16 *value){
    Std_ReturnType ret = (Std_ReturnType)0x00;
    if((TIMER3_obj==((void*)0))||(value==((void*)0)))
    {
        ret = (Std_ReturnType)0x00;
    }
    else
...
static void write_16bit_vlaue ( uint16 value){
 ...
 void ISR_TIMER3 (void){
     ...
     if(TIMER3_interrupt_handler!=((void*)0))
     {
