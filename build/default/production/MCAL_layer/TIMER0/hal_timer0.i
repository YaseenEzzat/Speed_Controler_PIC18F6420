...
# 49 "MCAL_layer/TIMER0/../mcal_std_types.h"
...
# 1 "MCAL_layer/TIMER0/../GPIO/hal_gpoi_config.h" 1
# 15 "MCAL_layer/TIMER0/../GPIO/hal_GPIO.h" 2
# 36 "MCAL_layer/TIMER0/../GPIO/hal_GPIO.h"
typedef enum {
    GPIO_PIN0 = 0,
    GPIO_PIN1,
    GPIO_PIN2,
...
# 1 "MCAL_layer/TIMER0/../INTERRUPT/mcal_interrupt_cnfg.h" 1
# 15 "MCAL_layer/TIMER0/../INTERRUPT/mcal_interrupt_config.h" 2
# 56 "MCAL_layer/TIMER0/../INTERRUPT/mcal_interrupt_config.h"
typedef enum {
...
# 170 "MCAL_layer/TIMER0/../INTERRUPT/mcal_internal_interrupt.h"
...
# 8 "MCAL_layer/TIMER0/hal_timer0.c" 2
 ...
 void(*TIMER0_interrupt_handler) (void) = ((void*)0);
...
Std_ReturnType TIMER0_initialization (const TIMER0_config_t *TIMER0_obj){
    ...
    else
    {
        ...
        if(TIMER0_obj->TIMER0_prescaler_state == TIMER0_prescaler_enable)
        {
            ...
            (T0CONbits.T0PS = TIMER0_obj->TIMER0_prescale_vlaue);
        }
...
Std_ReturnType TIMER0_read_counter_reg_vlaue (const TIMER0_config_t *TIMER0_obj , uint16 *value){
    Std_ReturnType ret = (Std_ReturnType)0x00;
    if((TIMER0_obj==((void*)0))||(value==((void*)0)))
    {
        ret = (Std_ReturnType)0x00;
    }
    else
...
static void write_16bit_vlaue ( uint16 value){
 ...
 void ISR_TIMER0 (void){
     ...
     if(TIMER0_interrupt_handler!=((void*)0))
     {
