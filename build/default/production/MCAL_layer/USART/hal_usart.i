...
# 49 "MCAL_layer/USART/../mcal_std_types.h"
...
# 15 "MCAL_layer/USART/../GPIO/hal_GPIO.h"
# 1 "MCAL_layer/USART/../GPIO/hal_gpoi_config.h" 1
...
# 1 "MCAL_layer/USART/../INTERRUPT/mcal_interrupt_cnfg.h" 1
# 15 "MCAL_layer/USART/../INTERRUPT/mcal_interrupt_config.h" 2
# 56 "MCAL_layer/USART/../INTERRUPT/mcal_interrupt_config.h"
typedef enum {
...
# 170 "MCAL_layer/USART/../INTERRUPT/mcal_internal_interrupt.h"
...
void(*Receive_Interrupt_handler)(void) = ((void*)0);
void(*Trans_Interrupt_handler)(void) = ((void*)0);
    ...
    else
    {
        switch (USART_config->buad_rate_mode) {
            case Asynchronous_low_speed_8bit:
                ...
                (BAUDCONbits.BRG16 = 0);
                (TXSTAbits.BRGH = 0);
                buad_rate_REG_value = (((16000000UL)/(USART_config->buad_rate_value))/64)-1;
                ret = (Std_ReturnType)0x01;
                break;
            case Asynchronous_high_speed_8bit:
                ...
                (BAUDCONbits.BRG16 = 0);
                (TXSTAbits.BRGH = 1);
                buad_rate_REG_value = (((16000000UL)/(USART_config->buad_rate_value))/16)-1;
                ret = (Std_ReturnType)0x01;
                break;
            ...
            case Asynchronous_high_speed_16bit:
                ...
                (BAUDCONbits.BRG16 = 1);
                (TXSTAbits.BRGH = 1);
                buad_rate_REG_value = (((16000000UL)/(USART_config->buad_rate_value))/4)-1;
                ret = (Std_ReturnType)0x01;
                break;
        ...
        (SPBRG) = (uint8)((uint32)buad_rate_REG_value);
        (SPBRGH) = (uint8)(((uint32)(buad_rate_REG_value))>>8);
    }
    return ret;
...
void ISR_USART_Trans(void){
    ...
    if (Trans_Interrupt_handler != ((void*)0))
    {
...
void ISR_USART_Receive(void){
    ...
    if (Receive_Interrupt_handler != ((void*)0))
    {
