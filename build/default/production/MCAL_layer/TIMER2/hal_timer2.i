...
# 49 "MCAL_layer/TIMER2/../mcal_std_types.h"
...
# 15 "MCAL_layer/TIMER2/../GPIO/hal_GPIO.h"
# 1 "MCAL_layer/TIMER2/../GPIO/hal_gpoi_config.h" 1
...
# 1 "MCAL_layer/TIMER2/../INTERRUPT/mcal_interrupt_cnfg.h" 1
...
# 170 "MCAL_layer/TIMER2/../INTERRUPT/mcal_internal_interrupt.h"
...
# 7 "MCAL_layer/TIMER2/hal_timer2.c" 2


 void(*TIMER2_interrupt_handler) (void) = ((void*)0);
...
Std_ReturnType TIMER2_initialization (const TIMER2_config_t *TIMER2_obj){
    ...
    else
    {
        ...
        (T2CONbits.T2CKPS = TIMER2_obj->TIMER2_prescale_vlaue);

        (T2CONbits.TOUTPS = TIMER2_obj->TIMER2_postscale_vlaue);
...
Std_ReturnType TIMER2_read_counter_reg_vlaue (const TIMER2_config_t *TIMER2_obj , uint8 *value){
    Std_ReturnType ret = (Std_ReturnType)0x00;
    if((TIMER2_obj==((void*)0))||(value==((void*)0)))
    {
        ret = (Std_ReturnType)0x00;
    }
    else
...
Std_ReturnType TIMER2_write_counter_reg_vlaue (const TIMER2_config_t *TIMER2_obj , uint8 value){
 ...
 void ISR_TIMER2 (void){
     (PIR1bits.TMR2IF = 0);
     TMR2 = preload_value;
     if(TIMER2_interrupt_handler!=((void*)0))
     {
