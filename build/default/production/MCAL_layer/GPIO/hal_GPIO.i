...
# 49 "MCAL_layer/GPIO/../mcal_std_types.h"
...
# 1 "MCAL_layer/GPIO/hal_gpoi_config.h" 1
...
Std_ReturnType GPIO_PIN_directoin_intialization (const pin_config_t *pin_config){
    ...
    if(((void*)0)==pin_config || (pin_config->PIN) > (8 -1))
    {
...
Std_ReturnType GPIO_PIN_get_directoin_status (const pin_config_t *pin_config ,pin_directoin_t *pin_directoin ){
    Std_ReturnType ret=(Std_ReturnType)0x01;
    if((((void*)0)==pin_config) || (((void*)0)==pin_directoin) || (pin_config->PIN) > (8 -1))
    {
        ret=(Std_ReturnType)0x00;
    }
    else
    {
        *pin_directoin= ((*TRIS_register[pin_config->PORT]>>pin_config->PIN)&1) ;
...
Std_ReturnType GPIO_PIN_read_logic (const pin_config_t *pin_config ,pin_logic_t *pin_logic ){
    Std_ReturnType ret=(Std_ReturnType)0x01;
    if((((void*)0)==pin_config) || (((void*)0)==pin_logic)|| (pin_config->PIN) > (8 -1))
    {
        ret=(Std_ReturnType)0x00;
    }
    else
    {
        *pin_logic= ((*PORT_register[pin_config->PORT]>>pin_config->PIN)&1) ;
...
# 152 "MCAL_layer/GPIO/hal_GPIO.c"
Std_ReturnType GPIO_PORT_directoin_intialization (port_index_t port , uint8 direction){
    Std_ReturnType ret=(Std_ReturnType)0x01;
    if(port>5 -1)
    {
...
# 175 "MCAL_layer/GPIO/hal_GPIO.c"
Std_ReturnType GPIO_PORT_get_directoin_status (port_index_t port ,uint8 *port_directoin ){
    Std_ReturnType ret=(Std_ReturnType)0x01;
    if((((void*)0)==port_directoin)||(port>5 -1))
    {
        ret=(Std_ReturnType)0x00;
    }
    else
...
# 197 "MCAL_layer/GPIO/hal_GPIO.c"
Std_ReturnType GPIO_PORT_write_logic (port_index_t port ,uint8 logic){
    Std_ReturnType ret=(Std_ReturnType)0x01;
    if(port>5 -1)
    {
...
# 220 "MCAL_layer/GPIO/hal_GPIO.c"
Std_ReturnType GPIO_PORT_read_logic (port_index_t port ,uint8 *logic){
    Std_ReturnType ret=(Std_ReturnType)0x01;
...
# 241 "MCAL_layer/GPIO/hal_GPIO.c"
Std_ReturnType GPIO_PORT_toggle (port_index_t port){
    Std_ReturnType ret=(Std_ReturnType)0x01;
    if(port>5 -1)
    {
...
# 262 "MCAL_layer/GPIO/hal_GPIO.c"
Std_ReturnType GPIO_PIN_intialization (const pin_config_t *pin_config){
    Std_ReturnType ret=(Std_ReturnType)0x01;
    if(((void*)0)==pin_config)
    {
