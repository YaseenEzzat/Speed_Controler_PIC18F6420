...
void(*External_INT0_interrupt_handler)(void) = ((void*)0);
void(*External_INT1_interrupt_handler)(void) = ((void*)0);
void(*External_INT2_interrupt_handler)(void) = ((void*)0);
...
void(*TEMP_External_RB_interrupt_handler)(void) = ((void*)0);
void ISR_RB (void);
...
Std_ReturnType ret = (Std_ReturnType)0x00;
    ...
    else
    {
        switch(INTx->INTx_pin){
            case INT0_pin:
                if(INTx->External_INTx_interrupt_handler != ((void*)0))
                {
...
Std_ReturnType INTERRUPT_RB_initialization (const interrupt_RB_config_t *RB ){
  Std_ReturnType ret = (Std_ReturnType)0x00;
    ...
    else
    {
        ...
        (INTCONbits.GIEH=1);
        (INTCONbits.GIEL=1);
# 380 "MCAL_layer/INTERRUPT/mcal_external_interrupt.c"
        (INTCONbits.RBIE = 0);
...
# 456 "MCAL_layer/INTERRUPT/mcal_external_interrupt.c"
static Std_ReturnType INTERRUPT_RB_set_PULL_UPS (const interrupt_RB_config_t *RB ){
Std_ReturnType ret = (Std_ReturnType)0x00;
    if(((void*)0)==RB)
    {
...
static Std_ReturnType INTERRUPT_RB_handler (const interrupt_RB_config_t *RB ){
 Std_ReturnType ret = (Std_ReturnType)0x00;
    ...
    {
        if(RB->External_RB_interrupt_handler !=((void*)0) )
        {
