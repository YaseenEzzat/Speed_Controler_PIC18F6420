# 1 "MCAL_layer/INTERRUPT/mcal_interrupt_manger.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "MCAL_layer/INTERRUPT/mcal_interrupt_manger.c" 2
...
# 1 "MCAL_layer/INTERRUPT/mcal_interrupt_manger.h" 1
# 12 "MCAL_layer/INTERRUPT/mcal_interrupt_manger.h"
...
# 49 "MCAL_layer/INTERRUPT/../mcal_std_types.h"
...
# 1 "MCAL_layer/INTERRUPT/../GPIO/hal_gpoi_config.h" 1
...
# 12 "MCAL_layer/INTERRUPT/mcal_interrupt_manger.h" 2
...
# 13 "MCAL_layer/INTERRUPT/mcal_interrupt_manger.h" 2
...
void __attribute__((picinterrupt((""))))Interrupt_Manger_high(void);
void __attribute__((picinterrupt(("low_priority"))))Interrupt_Manger_low(void);
...
void ISR_SPI (void);
# 8 "MCAL_layer/INTERRUPT/mcal_interrupt_manger.c" 2
...
void __attribute__((picinterrupt((""))))Interrupt_Manger_high(void){
   ...
   else if((INTCONbits.RBIF==1)&&(INTCONbits.RBIE==1))
   {

        ISR_RB();
   }
   else if((PIR1bits.ADIF==1)&&(PIE1bits.ADIE==1))
   {
   ...
   else if((PIR1bits.TMR2IF==1)&&(PIE1bits.TMR2IE==1))
   {
       ISR_TIMER2();

   }
   else if((PIR2bits.TMR3IF==1)&&(PIE2bits.TMR3IE==1))
   {
       ISR_TIMER3();

   }
   else if((PIR1bits.CCP1IF==1)&&(PIE1bits.CCP1IE==1))
   {
       ISR_CCP1();
   ...
   else if((PIR1bits.SSPIF==1)&&(PIE1bits.SSPIE==1))
   {
       ISR_SPI();
...
void __attribute__((picinterrupt(("low_priority"))))Interrupt_Manger_low(void){
   if((INTCON3bits.INT2F==1)&&(INTCON3bits.INT2E==1))
   {
