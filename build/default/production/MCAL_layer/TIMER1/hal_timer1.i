...
# 49 "MCAL_layer/TIMER1/../mcal_std_types.h"
...
# 1 "MCAL_layer/TIMER1/../GPIO/hal_gpoi_config.h" 1
...
# 1 "MCAL_layer/TIMER1/../INTERRUPT/mcal_interrupt_cnfg.h" 1
# 15 "MCAL_layer/TIMER1/../INTERRUPT/mcal_interrupt_config.h" 2
# 56 "MCAL_layer/TIMER1/../INTERRUPT/mcal_interrupt_config.h"
typedef enum {
...
# 170 "MCAL_layer/TIMER1/../INTERRUPT/mcal_internal_interrupt.h"
...
# 9 "MCAL_layer/TIMER1/hal_timer1.c" 2


 void(*TIMER1_interrupt_handler) (void) = ((void*)0);
...
Std_ReturnType TIMER1_initialization (const TIMER1_config_t *TIMER1_obj){
    ...
    else
    {
        ...
        (T1CONbits.T1CKPS = TIMER1_obj->TIMER1_prescale_vlaue);
...
Std_ReturnType TIMER1_read_counter_reg_vlaue (const TIMER1_config_t *TIMER1_obj , uint16 *value){
    Std_ReturnType ret = (Std_ReturnType)0x00;
    if((TIMER1_obj==((void*)0))||(value==((void*)0)))
    {
        ret = (Std_ReturnType)0x00;
    }
    else
...
static void write_16bit_vlaue ( uint16 value){
 ...
 void ISR_TIMER1 (void){
     ...
     if(TIMER1_interrupt_handler!=((void*)0))
     {
