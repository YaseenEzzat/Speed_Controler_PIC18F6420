...
# 49 "MCAL_layer/ADC/../mcal_std_types.h"
...
void (*ADC_INTRRUPT_HANDLER)(void)=((void*)0);
void ISR_ADC (void);
...
Std_ReturnType ADC_initialization (const ADC_config_t *ADC_obj){
    ...
    else
    {
        ...
        (ADCON2bits.ADCS = ADC_obj->CLCK_SELECT);
...
# 92 "MCAL_layer/ADC/hal_ADC.c"
Std_ReturnType ADC_read_converted_value (const ADC_config_t *ADC_obj , uint16 *value){
    Std_ReturnType ret = (Std_ReturnType)0x00;
    uint16 ADRESH_value = 0;
    uint16 ADRESL_value = 0;
    if((((void*)0)==ADC_obj)||(((void*)0)==value))
    {
        ret = (Std_ReturnType)0x00;
    }
    else
...
static Std_ReturnType ADC_set_channel_pin_direction (ADC_channel_t CHANNEL){
    Std_ReturnType ret = (Std_ReturnType)0x00;
        ...
        switch (CHANNEL){
            case Channel_0 : (TRISA|=(1<<0)); ret = (Std_ReturnType)0x00; break;
            case Channel_1 : (TRISA|=(1<<1)); ret = (Std_ReturnType)0x00; break;
            case Channel_2 : (TRISA|=(1<<2)); ret = (Std_ReturnType)0x00; break;
            case Channel_3 : (TRISA|=(1<<3)); ret = (Std_ReturnType)0x00; break;
            case Channel_4 : (TRISA|=(1<<5)); ret = (Std_ReturnType)0x00; break;
            case Channel_5 : (TRISE|=(1<<0)); ret = (Std_ReturnType)0x00; break;
            case Channel_6 : (TRISE|=(1<<1)); ret = (Std_ReturnType)0x00; break;
            case Channel_7 : (TRISE|=(1<<2)); ret = (Std_ReturnType)0x00; break;
            case Channel_8 : (TRISB|=(1<<2)); ret = (Std_ReturnType)0x00; break;
            case Channel_9 : (TRISB|=(1<<3)); ret = (Std_ReturnType)0x00; break;
            case Channel_10 : (TRISB|=(1<<1)); ret = (Std_ReturnType)0x00; break;
            case Channel_11 : (TRISB|=(1<<4)); ret = (Std_ReturnType)0x00; break;
            case Channel_12 : (TRISB|=(1<<0)); ret = (Std_ReturnType)0x00; break;
...
void ISR_ADC (void){
    (PIR1bits.ADIF=0);
    if(((void*)0)!=ADC_INTRRUPT_HANDLER)
