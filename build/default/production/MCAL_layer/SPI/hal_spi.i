...
# 49 "MCAL_layer/SPI/../mcal_std_types.h"
...
# 15 "MCAL_layer/SPI/../GPIO/hal_GPIO.h"
# 1 "MCAL_layer/SPI/../GPIO/hal_gpoi_config.h" 1
# 15 "MCAL_layer/SPI/../GPIO/hal_GPIO.h" 2
# 36 "MCAL_layer/SPI/../GPIO/hal_GPIO.h"
typedef enum {
    GPIO_PIN0 = 0,
    GPIO_PIN1,
    GPIO_PIN2,
...
# 1 "MCAL_layer/SPI/../INTERRUPT/mcal_interrupt_cnfg.h" 1
...
# 170 "MCAL_layer/SPI/../INTERRUPT/mcal_internal_interrupt.h"
...
void(*SPI_INTERRUPT_HANDLER)(void)=((void*)0);
void ISR_SPI (void);
...
Std_ReturnType SPI_MASTER_Initialization(const SPI_Master_mode_config *Master){
    ...
    else
    {
        ...
        TRISCbits.RC3=0;
        TRISAbits.RA5=0;
        (SSPCON1bits.SSPM = Master->SPI_Master_mode);
...
Std_ReturnType SPI_SLAVE_Initialization(const SPI_Slave_mode_config *Slave){
    ...
    else
    {
        ...
        TRISCbits.RC3=1;
        TRISAbits.RA5=1;
        (SSPCON1bits.SSPM = Slave->SPI_Slave_mode);
...
Std_ReturnType SPI_Master_Read_8_bit_Data_Interrupt(const SPI_Master_mode_config *Master ,uint8 *data_read){
    Std_ReturnType ret = (Std_ReturnType)0x00;
    if((Master==((void*)0))||(data_read==((void*)0)))
    {
        ret = (Std_ReturnType)0x00;
    }
    else
...
void ISR_SPI (void){
    ...
    if(SPI_INTERRUPT_HANDLER != ((void*)0))
    {
